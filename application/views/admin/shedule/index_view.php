            ...
            <div class="well">
                <div class="row">
                    <div class="col-6 col-sm-6 col-lg-4">
                        ...
                        <?php foreach ($n_short_group_num_pars as $item): ?>
                            <p><?= $item['name'] ?> - <?php if ($item['pars'] < 18): ?><span
                                    style="color: red"><?= $item['pars'] ?> пар (<?= $item['pars'] * 2 ?>
                                    часов)</span><?php else: ?><span style="color: green"><?= $item['pars'] ?> пар
                    ...
                    <div class="col-6 col-sm-8 col-lg-6">
                        ...
                        <?php foreach ($n_short_num_pars as $item): ?>
                            <p><?= $item['first_name'] ?> <?= $item['last_name'] ?> <?= $item['patronymic'] ?>
                                - <?= $item['pars'] ?> пар</p>
                        <?php endforeach ?>
                        <p><a class="btn btn-default"
