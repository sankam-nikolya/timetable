...
<div class="container">
    ...
    <a href="<?=base_url()?>index.php/admin_shedule/delete_db_subject/?id=<?=$info[0]['idsubects']?>" class="btn btn-danger btn-sm">Удалить</a>
    <hr>
    <form method="post" action="<?=base_url()?>index.php/admin_shedule/update_db_subject/?id=<?=$info[0]['idsubects']?>">
