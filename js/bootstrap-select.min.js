...
!function (b) {
    ...
    a.prototype = {constructor: a, init: function (d) {
        this.$element.hide();
        ...
        if (this.options.size == "auto") {
            var e = function () {
                ...
                d.css({"max-height": q + "px", overflow: "hidden", "min-height": w + "px"});
                i.css({"max-height": q - s - l - r + "px", "overflow-y": "auto", "min-height": w - r + "px"})
            };
            e();
            b(window).resize(e);
            b(window).scroll(e)
            ...
            if (this.options.size && this.options.size != "auto" && d.find("li" + o).length > this.options.size) {
                ...
                d.css({"max-height": q + s + l + "px", overflow: "hidden"});
                i.css({"max-height": q - r + "px", "overflow-y": "auto"})
            }
        }
    }, setWidth: function () {
        ...
        this.$menu.on("click", "li a", function (k) {
            var f = b(this).parent().index(), j = b(this).parent(), i = c.$element.val();
            if (c.multiple) {
                k.stopPropagation()
            }
            k.preventDefault();
        ...
        if (/(38|40)/.test(o.keyCode)) {
            ...
            var f = {48: "0", 49: "1", 50: "2", 51: "3", 52: "4", 53: "5", 54: "6", 55: "7", 56: "8", 57: "9", 59: ";", 65: "a", 66: "b", 67: "c", 68: "d", 69: "e", 70: "f", 71: "g", 72: "h", 73: "i", 74: "j", 75: "k", 76: "l", 77: "m", 78: "n", 79: "o", 80: "p", 81: "q", 82: "r", 83: "s", 84: "t", 85: "u", 86: "v", 87: "w", 88: "x", 89: "y", 90: "z", 96: "0", 97: "1", 98: "2", 99: "3", 100: "4", 101: "5", 102: "6", 103: "7", 104: "8", 105: "9"};
            var c = [];
            n.each(function () {
    ...
    b.fn.selectpicker.defaults = {style: "btn-default", size: "auto", title: null, selectedTextFormat: "values", noneSelectedText: "", countSelectedText: "{0} of {1} selected", width: false, container: false, hideDisabled: false, showSubtext: false, showIcon: true, showContent: true, dropupAuto: true, header: false, liveSearch: false};
