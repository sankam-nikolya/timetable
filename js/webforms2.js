    ...
    if (document.implementation && document.implementation.hasFeature && !document.implementation.hasFeature('WebForms', '2.0')) {
        $wf2 = {
                    ...
                    if (
                        ...
                        for (j = 0; clr = clrs[j]; j++) {
                            if (clr.namespaceURI == 'http://n.whatwg.org/formdata' &&
                                clr.parentNode == root && !clr.firstChild &&
                        ...
                        for (j = 0; rpt = rpts[j]; j++) {
                            if (rpt.namespaceURI == 'http://n.whatwg.org/formdata' &&
                                rpt.parentNode == root && !rpt.firstChild &&
            ...
            initRepetitionTemplates: function (parentNode) {
                var repetitionTemplates = $wf2.getElementsByTagNamesAndAttribute.apply((parentNode || document.documentElement), [
                    ['*'],
                    'repeat',
                    'template'
                ]);
            ...
            initRepetitionBlocks: function (parentNode) {
                var repetitionBlocks = $wf2.getElementsByTagNamesAndAttribute.apply((parentNode || document.documentElement), [
                    ['*'],
                    'repeat',
                    'template',
                    true
            ...
            initRepetitionButtons: function (btnType, parent) {
                ...
                var inpts = $wf2.getElementsByTagNamesAndAttribute.apply(parent, [
                    ['input'],
                    'type',
                    btnType
                ]);
                ...
                var btns = $wf2.getElementsByTagNamesAndAttribute.apply(parent, [
                    ['button'],
                    'type',
                    btnType
                ]);
            ...
            removeRepetitionBlock: function () {
                ...
                if (this.repetitionTemplate != null) {
                    ...
                    if (this.repetitionTemplate.repetitionBlocks.length < this.repetitionTemplate.repeatMax) {
                        var addBtns = $wf2.getElementsByTagNamesAndAttribute.apply(document.documentElement, [
                            ['button'],
                            'type',
                            'add'
                        ]);
            ...
            updateAddButtons: function (rt) {
                ...
                var btns = $wf2.getElementsByTagNamesAndAttribute.apply(document.documentElement, [
                    ['button'],
                    'type',
                    'add'
                ]);
            ...
            updateMoveButtons: function (parent) {
                ...
                if (!parent) {
                    var visitedParents = [];
                    rbs = $wf2.getElementsByTagNamesAndAttribute.apply(document.documentElement, [
                        ['*'],
                        'repeat',
                        'template',
                        true
                ...
                for (i = 0; block = rbs[i]; i++) {
                    var moveUpBtns = $wf2.getElementsByTagNamesAndAttribute.apply(block, [
                        ['button'],
                        'type',
                        'move-up'
                    ]);
                    ...
                    var moveDownBtns = $wf2.getElementsByTagNamesAndAttribute.apply(block, [
                        ['button'],
                        'type',
                        'move-down'
                    ]);
            ...
            initNonRepetitionFunctionality: function (parent) {
                ...
                var els = $wf2.getElementsByTagNamesAndAttribute.apply(document.documentElement, [
                    ['*'],
                    'autofocus'
                ]);
                ...
                var textareas = $wf2.getElementsByTagNamesAndAttribute.apply(parent, [
                    ['textarea'],
                    'maxlength'
                ]);
